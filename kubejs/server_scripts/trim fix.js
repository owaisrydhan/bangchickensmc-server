ServerEvents.tags('item', event => {
    ...
    event.remove('minecraft:trim_materials', 'caverns_and_chasms:spinel')
    event.remove('minecraft:trim_materials', 'caverns_and_chasms:living_flesh')
    event.remove('minecraft:trim_materials', 'caverns_and_chasms:necromium_ingot')
